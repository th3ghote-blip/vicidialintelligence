...
type Message = { role: string; msg: string };
...
export default function AISection({ lang, content }: { lang: Lang; content: AISectionContent }) {
  return (
        ...
        <div className="rounded-2xl border border-emerald-500/20 bg-gradient-to-br from-emerald-500/5 to-zinc-900/60 p-8 sm:p-12">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="rounded-xl border border-zinc-700 bg-zinc-900 p-4 space-y-3">
              <div className="text-xs text-zinc-500 font-medium mb-4">{content.chatLabel}</div>
              ...
              <div className="flex items-center gap-2 border-t border-zinc-800 pt-3 mt-2">
                <div className="flex-1 h-7 rounded-lg bg-zinc-800 text-[10px] text-zinc-600 flex items-center px-3">{content.chatPlaceholder}</div>
