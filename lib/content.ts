...
export const mockup = {
  en: {
    navItems: ["Summary", "Alerts", "Agents", "Momentum", "Insights", "Leads"],
    kpiLabels: ["Sales Today", "Active Agents", "Close Rate", "Avg Handle", "Callbacks"],
    kpiSubs: ["+12.3% vs yesterday", "of 31 available", "target: 16%", "mins / call", "pending today"],
    kpiTrends: [true, null, null, null, null],
    kpiValues: ["284", "23", "15.4%", "4.2m", "47"],
    chartTitle: "Sales by hour — today",
    campaignTitle: "Campaigns",
    campaignCols: ["Campaign", "Agts", "Sales", "Close%"],
    agentsTitle: "Top Agents",
    agentCols: ["Agent", "Sales", "Close%"],
    insightTitle: "AI Insight",
    insightText: "Solar LATAM trending +18% vs last week. Recommend shifting 2–3 agents from Debt Relief US before the 14:00 peak.",
  ...
  es: {
    navItems: ["Resumen", "Alertas", "Agentes", "Momentum", "Insights", "Leads"],
    kpiLabels: ["Ventas Hoy", "Agentes Activos", "Tasa de Cierre", "T. Promedio", "Callbacks"],
    kpiSubs: ["+12.3% vs ayer", "de 31 disponibles", "objetivo: 16%", "min / llamada", "pendientes hoy"],
    kpiTrends: [true, null, null, null, null],
    kpiValues: ["284", "23", "15.4%", "4.2m", "47"],
    chartTitle: "Ventas por hora — hoy",
    campaignTitle: "Campañas",
    campaignCols: ["Campaña", "Agts", "Ventas", "Cierre%"],
    agentsTitle: "Mejores Agentes",
    agentCols: ["Agente", "Ventas", "Cierre%"],
    insightTitle: "Insight IA",
    insightText: "Solar LATAM con tendencia +18% vs semana pasada. Recomiendo mover 2–3 agentes de Debt Relief US antes del pico de las 14:00.",
  ...
  pt: {
    navItems: ["Resumo", "Alertas", "Agentes", "Momentum", "Insights", "Leads"],
    kpiLabels: ["Vendas Hoje", "Agentes Ativos", "Taxa de Fech.", "T. Médio", "Callbacks"],
    kpiSubs: ["+12.3% vs ontem", "de 31 disponíveis", "meta: 16%", "min / chamada", "pendentes hoje"],
    kpiTrends: [true, null, null, null, null],
    kpiValues: ["284", "23", "15.4%", "4.2m", "47"],
    chartTitle: "Vendas por hora — hoje",
    campaignTitle: "Campanhas",
    campaignCols: ["Campanha", "Agts", "Vendas", "Fech.%"],
    agentsTitle: "Melhores Agentes",
    agentCols: ["Agente", "Vendas", "Fech.%"],
    insightTitle: "Insight IA",
    insightText: "Solar LATAM com tendência +18% vs semana passada. Recomendo mover 2–3 agentes de Debt Relief US antes do pico das 14h.",
    momentumTitle: "Momentum de Agentes",
